 ...
 */
  ...
  //|----+----+----+----+----+----+----|                                                         |----+----+----+----+----+----+----|
	 MO(_INTER),KC_LCTL,KC_HYPR,KC_LALT,   KC_LCMD,   KC_BSPC,KC_LCTL,               KC_ENT,KC_SPC     ,    KC_RCMD    , MO(_ADJUST),KC_HYPR,KC_RCTL,MO(_INTER)
  //`----+----+----+----+----+----+----'                                                         `----+----+----+----+----+----+----'
  ),
 ...
 */
  ...
  [_SYMB] = LAYOUT(
	...
	_______, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC, _______,                             _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_MINS, KC_UNDS, UC(0x2019),
	_______, _______, _______, _______, _______, _______, _______,                             _______, _______, _______, _______, _______, _______, _______,
	_______, _______, _______, _______, _______, _______, _______,                             _______, _______, _______, _______, _______, _______, _______
  ),
